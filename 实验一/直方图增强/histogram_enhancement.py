...
from src.experiments import exp1_1

if __name__ == "__main__":
    print("Running Experiment 1-1 (Wrapper)...")
    # Redirect output to multimedia_code/output/exp1_1_histogram
    output_dir = os.path.join(multimedia_code_path, 'output', 'exp1_1_histogram')
    ...
    exp1_1.run(image_path, output_dir)
