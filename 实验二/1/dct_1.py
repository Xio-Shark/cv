...
from src.experiments import exp2_1

if __name__ == "__main__":
    print("Running Experiment 2-1 (Wrapper)...")
    # Redirect output to multimedia_code/output/exp2_1_block_dct
    output_dir = os.path.join(multimedia_code_path, 'output', 'exp2_1_block_dct')
    ...
    exp2_1.run(image_path, output_dir)