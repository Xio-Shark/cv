...
from src.experiments import exp2_2

if __name__ == "__main__":
    print("Running Experiment 2-2 (Wrapper)...")
    # Redirect output to multimedia_code/output/exp2_2_global_dct
    output_dir = os.path.join(multimedia_code_path, 'output', 'exp2_2_global_dct')
    ...
    exp2_2.run(image_path, output_dir)
