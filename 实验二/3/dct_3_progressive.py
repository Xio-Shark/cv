...
from src.experiments import exp2_3_progressive

if __name__ == "__main__":
    print("Running Experiment 2-3 Progressive (Wrapper)...")
    # Redirect output to multimedia_code/output/exp2_3_progressive
    output_dir = os.path.join(multimedia_code_path, 'output', 'exp2_3_progressive')
    ...
    exp2_3_progressive.run(image_path, output_dir)
